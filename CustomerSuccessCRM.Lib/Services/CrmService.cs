...
namespace CustomerSuccessCRM.Lib.Services
{
    public class CrmService : ICrmService
    {
        ...
        public async Task<IEnumerable<Interacao>> GetInteracoesByClienteAsync(int clienteId)
        {
        ...
        public async Task<Oportunidade> CreateOportunidadeAsync(Oportunidade oportunidade)
        {
            ...
            return await _oportunidadeRepository.AddAsync(oportunidade);
        }
        ...
        public async Task<IEnumerable<Oportunidade>> GetOportunidadesByClienteAsync(int clienteId)
        {
